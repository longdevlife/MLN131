...
export const coverBack = {
  ...
  edition: 'Bộ Giáo dục và Đào tạo · Nhà xuất bản Chính trị Quốc gia Sự thật (2021)',
  summary: 'Chương 5: Cơ cấu xã hội – giai cấp và liên minh giai cấp, tầng lớp trong thời kỳ quá độ lên chủ nghĩa xã hội.',
  colophon: 'Bản số hóa không gian 3D tương tác · Đại học FPT · Năm 2026',
};
